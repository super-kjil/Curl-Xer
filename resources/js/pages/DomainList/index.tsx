                ...
                <div className="flex-1 space-y-4 p-8 md:p-8 pt-4">
                    ...
                    <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
                        <Card>
                            ...
                            <CardContent>
                                <Button asChild className="w-full">
                                    <a href="http://87.247.167.28:8001/admin/domain-manager" target="_blank" rel="noopener noreferrer">
                                        Open Dashboard 28
                                    </a>
                                </Button>
                            </CardContent>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <Button asChild className="w-full">
                                    <a href="http://87.247.167.29:8001/admin/domain-manager" target="_blank" rel="noopener noreferrer">
                                        Open Dashboard 29
                                    </a>
                                </Button>
                            </CardContent>
