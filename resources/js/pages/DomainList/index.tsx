                    ...
                    <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
                        <Card>
                            <CardHeader>
                                <CardTitle className="flex items-center gap-2">
                                    ...
                                    <Badge className='text-lg'>DNS 28</Badge>
                                </CardTitle>
                                <CardDescription>
                        ...
                        <Card>
                            <CardHeader>
                                <CardTitle className="flex items-center gap-2">
                                    ...
                                    <Badge className='text-lg'>DNS 29</Badge>
                                </CardTitle>
                                <CardDescription>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Access ADGUARD HOME DNS 29
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <Button asChild className="w-full">
                                    <a href="http://87.247.167.29:8000/#filters" target="_blank" rel="noopener noreferrer">
                                        Open ADGUARD 29
                                    </a>
                                </Button>
                            </CardContent>
